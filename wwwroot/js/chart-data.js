...
$(document).ready(function() {
    // Area Chart for New and Old Students
    var areaChartOptions = {
        series: [
            { name: 'الطلاب المستجدين', data: [31, 40, 28, 51, 42, 109, 100] },
            { name: 'الطلاب غير المستجدين', data: [11, 32, 45, 32, 34, 52, 41] }
        ],
    ...
    // Bar Chart for New and Old Students
    var barChartOptions = {
        series: [
    ...
    // Line Chart for Value over months
    ...
    // Donut Chart for displaying categories
    Morris.Donut({
        element: 'chart3',
        data: [
